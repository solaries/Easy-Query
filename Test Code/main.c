...
fields[1] = new_field(3, 40, 0, 15, 0, 0);
	fields[2] = new_field(1, 10, 10, 0, 0, 0);
fields[3] = new_field(1, 40, 10, 15, 0, 0);
	fields[4] = NULL;
...
set_field_opts(fields[1], O_VISIBLE | O_PUBLIC | O_EDIT | O_ACTIVE | O_WRAP);
